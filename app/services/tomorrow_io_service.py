...
class TomorrowIOService:
    ...
    async def get_current_and_forecast(
        self, latitude: float, longitude: float, timesteps: List[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def get_weather_map_tiles(
        self, latitude: float, longitude: float, layer: str, zoom: int = 10
    ) -> Dict[str, Any]:
        """
    ...
    def _parse_historical_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"observations": observations, "source": "Tomorrow.io"}
    ...
    def _parse_hail_probability_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"hail_probability": hail_data, "source": "Tomorrow.io"}
    ...
    def _parse_fire_risk_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"fire_index": fire_data, "source": "Tomorrow.io"}
